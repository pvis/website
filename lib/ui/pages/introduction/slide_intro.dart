...
class SlideIntroPage extends StatefulWidget {
  @override
  _SlideIntroPageState createState() => _SlideIntroPageState();
}

class _SlideIntroPageState extends State<SlideIntroPage> {
  ...
  Widget build(BuildContext context) {
    ...
    var _appbarHeight = Responsive.isDesktop(context) ? 80.0 : 60.0;
